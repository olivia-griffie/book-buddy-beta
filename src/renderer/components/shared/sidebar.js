const icons = {
  ...
  inbox: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="15" height="15" aria-hidden="true"><path d="M19 3H5c-1.1 0-2 .9-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zm0 16H5v-3h3.54c.65 1.15 1.87 1.95 3.29 1.95 1.42 0 2.63-.8 3.29-1.95H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>`,
  sharing: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="15" height="15" aria-hidden="true"><path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92s2.92-1.31 2.92-2.92-1.31-2.92-2.92-2.92z"/></svg>`,
  ...
  container.innerHTML = `
    <div class="sidebar ${isCollapsed ? 'is-collapsed' : ''}">
      ...
      <div class="sidebar-brand">
        ${isCollapsed ? '' : `
          <img
            ...
            src="${window.isDarkMode?.() ? '../../public/logo-dark.png' : '../../public/logo-full.png'}"
            alt="Book Buddy"
          />
      ...
      <div class="sidebar-footer">
        <button
          type="button"
          class="sidebar-link ${currentPage === 'account' ? 'is-active' : ''}"
          data-page="account"
        >
          <span class="sidebar-link-icon" aria-hidden="true">${icons.account}</span>
          ${isCollapsed ? '' : `<span class="sidebar-link-label">Account</span>`}
        </button>
        <button
          type="button"
