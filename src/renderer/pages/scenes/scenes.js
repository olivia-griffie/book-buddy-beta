window.registerPageInit('scenes', async function ({ project }) {
  ...
  const sceneTagDescriptions = {
    Setup: 'A plot point for establishing the story world, important relationships, baseline stakes, and the normal before disruption.',
    Disruption: 'A plot point for the event or pressure that unsettles the existing order and pushes the story into motion.',
    Flashback: 'A plot point or technique that returns to earlier events to reveal context, memory, trauma, or hidden cause.',
    'Internal Conflict': 'A plot point for a character private struggle, contradiction, fear, desire, guilt, or difficult choice.',
    Revelation: 'A plot point where new information changes the meaning of events, relationships, plans, or identity.',
    Crisis: 'A plot point where pressure peaks into a decisive problem, failure, danger, or impossible choice.',
    Climax: 'A plot point for the major confrontation or highest-intensity turning point of the story arc.',
    Aftermath: 'A plot point for consequences, emotional fallout, recovery, damage, or changed relationships after a major event.',
    Resolution: 'A plot point for closure, repair, final choices, new stability, or the story ending state.',
